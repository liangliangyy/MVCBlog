...
namespace MVCBlog.Common.OAuthor
{
    public class WeiBoOAuthor : OpenAuthenticationClientBase
    {
        ...
        public WeiBoOAuthor(string appKey, string appSecret, string callbackUrl, string accessToken = null, string uid = null)
